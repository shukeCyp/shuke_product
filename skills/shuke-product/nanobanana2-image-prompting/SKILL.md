...
- Nano Banana 2 is officially `Gemini 3.1 Flash Image Preview`; read the workspace model code from `google_prompting.nano_banana2.official_model` in `../config/media_services.yaml`.
...
- Use `google_prompting.nano_banana2.official_model` from `../config/media_services.yaml` for Nano Banana 2.
