...
Always save video analysis outputs under the current working directory's `skills/shuke-product/vault/` folder.
...
API_KEY = "<read yunwu.api_key from ../config/media_services.yaml>"
BASE_URL = "<read yunwu.base_url from ../config/media_services.yaml>"
MODEL = "<read yunwu.models.analysis_preferred from ../config/media_services.yaml>"
...
- Yunwu Apifox video understanding: read `yunwu.apifox_doc_url` from `../config/media_services.yaml`
