...
description: Use this skill after video understanding to convert带货视频 analysis into standardized product/video/hook tags, JSON records, and searchable index entries saved under the current workspace's 剧本 folder.
---
...
Always use the current working directory's `剧本/` folder:
...
4. Write `剧本/tags/<video_id>.json`.
5. Append or update one compact JSON object in `剧本/index/videos.jsonl`.
